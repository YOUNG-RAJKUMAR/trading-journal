function getSessionHighLowStudy(PineJS) {
    ...
    Study.prototype.main = function(context, inputCallback) {
        ...
        const getVal = (id, type) => {
            ...
            // CRITICAL: Return NaN on the very first bar of the session 
            // to prevent the charting library from connecting to the previous day/level
    ...
    return {
        ...
        metainfo: {
            _metainfoVersion: 51,
            id: "NepalSessionHL@tv-basicstudies-7",
            ...
            styles: {
                // linestyle 3 is Dotted (Even more spaced than dashed)
                // plottype 8 is Line with Breaks (Ensures no vertical lines)
