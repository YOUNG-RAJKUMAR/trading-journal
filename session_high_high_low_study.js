function getSessionHighLowStudy(PineJS) {
    ...
    Study.prototype.main = function(context, inputCallback) {
        ...
        return [ getVal('asia', 'high'), getVal('asia', 'low'), getVal('london', 'high'), getVal('london', 'low'), getVal('newyork', 'high'), getVal('newyork', 'low') ];
    };
    ...
    return {
        ...
        metainfo: {
            ...
            inputs: [ { id: "lineWidth", name: "Line Width", type: "integer", min: 1, max: 5, defval: 2 } ],
            defaults: {
                styles: {
