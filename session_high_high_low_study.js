function getSessionHighLowStudy(PineJS) {
    ...
    Study.prototype.main = function(context, inputCallback) {
        ...
        sessions.forEach(s => {
            ...
            if (inSession) {
                if (!data.isActive) {
                    ...
                    data.endBar = null;
                    data.day = dayId; // Lock to current day
                } else {
        ...
        const getVal = (id, type) => {
            ...
            // CRITICAL: If the bar's day doesn't match the session's day, return NaN
            if (d.day !== dayId) return NaN;
    ...
    return {
        ...
        metainfo: {
            _metainfoVersion: 51,
            id: "NepalSessionHL@tv-basicstudies-3",
            ...
            styles: {
                // plottype 8 is Line With Breaks (Best for clean daily separation)
