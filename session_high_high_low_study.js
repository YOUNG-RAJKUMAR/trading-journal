function getSessionHighLowStudy(PineJS) {
    ...
    Study.prototype.main = function(context, inputCallback) {
        ...
        const sessions = [
            { id: 'asia', start: parseTime(this._input(2)), end: parseTime(this._input(3)) },
            { id: 'london', start: parseTime(this._input(4)), end: parseTime(this._input(5)) },
            { id: 'newyork', start: parseTime(this._input(6)), end: parseTime(this._input(7)) }
        ];
    ...
    return {
        ...
        metainfo: {
            ...
            styles: {
                asiaHigh: { title: 'Asia High', linestyle: 0, linewidth: 2, plottype: 8, trackPrice: false, color: '#0000FF' },
                asiaLow: { title: 'Asia Low', linestyle: 0, linewidth: 2, plottype: 8, trackPrice: false, color: '#0000FF' },
                lonHigh: { title: 'London High', linestyle: 0, linewidth: 2, plottype: 8, trackPrice: false, color: '#FF0000' },
                lonLow: { title: 'London Low', linestyle: 0, linewidth: 2, plottype: 8, trackPrice: false, color: '#FF0000' },
                nyHigh: { title: 'NY High', linestyle: 0, linewidth: 2, plottype: 8, trackPrice: false, color: '#008000' },
                nyLow: { title: 'NY Low', linestyle: 0, linewidth: 2, plottype: 8, trackPrice: false, color: '#008000' }
            },
            inputs: [
            ...
            defaults: {
                styles: {
                    asiaHigh: { color: '#0000FF', visible: true, linewidth: 2 },
                    asiaLow: { color: '#0000FF', visible: true, linewidth: 2 },
                    lonHigh: { color: '#FF0000', visible: true, linewidth: 2 },
                    lonLow: { color: '#FF0000', visible: true, linewidth: 2 },
                    nyHigh: { color: '#008000', visible: true, linewidth: 2 },
                    nyLow: { color: '#008000', visible: true, linewidth: 2 }
                },
                inputs: {
                    lineWidth: 2,
                    labelSize: "small",
