function getSessionHighLowStudy(PineJS) {
    ...
    Study.prototype.main = function(context, inputCallback) {
        ...
        const getVal = (id, type) => {
            ...
            // ONLY return the value if the session is active AND not broken
            // This prevents lines from connecting between days or sessions
            if (!d.isActive || isNaN(d.high) || d.broken[type]) return NaN;
    ...
    return {
        ...
        metainfo: {
            ...
            defaults: {
                styles: {
                    asiaHigh: { color: '#2962FF', visible: true, linewidth: 2, plottype: 2 },
                    asiaLow: { color: '#2962FF', visible: true, linewidth: 2, plottype: 2 },
                    lonHigh: { color: '#E91E63', visible: true, linewidth: 2, plottype: 2 },
                    lonLow: { color: '#E91E63', visible: true, linewidth: 2, plottype: 2 },
                    nyHigh: { color: '#FF9800', visible: true, linewidth: 2, plottype: 2 },
                    nyLow: { color: '#FF9800', visible: true, linewidth: 2, plottype: 2 }
                },
                inputs: {
                    lineWidth: 2,
